from ragCore.evaluator import Evaluator
from ragCore.dataset.utils import split_dataset, merge_dataset
from ragCore.utils import get_retriever, get_generator, get_refiner, get_judger
from ragCore.prompt import PromptTemplate
...
if __name__ == '__main__':
    ...
    from ragCore.utils import get_dataset
    from ragCore.prompt import PromptTemplate

    config = {

        # 以下是必须结合自己实际情况修改的参数
        'dataset_path': '/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/ragCore/data/test',  # 评估数据集的存放路径
        "index_path": "/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/knowledge_base/wiki/vector_store/bge-large-zh-v1.5/index.faiss",
        # 向量索引存放路径
        "corpus_path": "/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/ragCore/data/indexes/sample_data.jsonl",
        # 原始文本存放路径
        "retrieval_model_path": "/root/autodl-tmp/data/ai-modelscope/bge-large-zh-v1___5",  # 用于检索的模型存放路径
        "retrieval_cache_path": "/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/ragCore/data/cache",  # 检索缓存存放目录
        "generator_model": "chatglm3-6b",  # 生成模型名称
        "generator_model_path": "/root/autodl-tmp/data/ZhipuAI/chatglm3-6b",  # 生成模型存放路径
        "save_dir": "/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/ragCore/data/result",  # 评估结果存放路径
