...
class BM25Retriever(BaseRetriever):
    ...
    def __init__(self, config):
        ...
        self.searcher = LuceneSearcher("/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.2/server/indexes")
...
# 定义检索器配置
retriever_config = {
    'data_dir': '/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/server/dataset/',
    'index_path': '/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/server/indexes/e5_flat_sample.index',
    'corpus_path': '/root/autodl-tmp/JeeShyang-RAG/JeeShyang-RAG-0.1/server/indexes/sample_data.jsonl',
    'device': 'cpu',
